...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 border-b-2 border-gray-200 dark:border-gray-700 shadow-lg w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3 flex-shrink-0">
            ...
            {user ? (
              <div className="relative" ref={userDropdownRef}>
                <button
                  ...
                  className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 border-2 border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                >
            ...
            <Link
              ...
              <div className="flex items-center space-x-3">
                <Link
                  to="/login"
                  className="px-4 py-3 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200 border-2 border-transparent hover:border-blue-200 dark:hover:border-blue-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="px-4 py-3 text-sm font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 border-2 border-blue-600 hover:border-blue-700 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                >
                  Sign Up
                </Link>
              </div>
            ...
            <button
              ...
              className="md:hidden p-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 border-2 border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
        ...
        {mobileMenuOpen && (
          <div
            ref={mobileMenuRef}
            className="md:hidden border-t-2 border-gray-200 dark:border-gray-700 py-4 bg-gray-50 dark:bg-gray-800"
          >
